...
| ESC/Label color label printers (Epson Colorworks CW-C4000, CW-C6000, CW-C6500) | ✔️ | ✔️ | | Ticket printing, badge printing |
...
* Download the [Evolis SDK/Wrapper](https://sdk.evolis.com/#toolkits/MobileDemoApp.htm?TocPath=Tools%257C_____4), and extract the file ``java-android/evolis-sdk-android.aar``
